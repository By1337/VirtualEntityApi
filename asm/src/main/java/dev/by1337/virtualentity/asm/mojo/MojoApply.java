package dev.by1337.virtualentity.asm.mojo;

import dev.by1337.virtualentity.asm.ASMWriter;
...
public class MojoApply extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        if (!atomicBoolean.get()) {
            ...
            try {
                Files.move(input.toPath(), new File(input.getParent(), input.getName() + "-raw-asm.jar").toPath(), StandardCopyOption.REPLACE_EXISTING);
